...
{   //Con este controlador añadimos a los clientes
                        ...
                        if ($insertarCuenta->rowCount() >= 1) {
                            ...
                            if ($guardarUsuario->rowCount() >= 1) {
                                ...
                                $alert = [
                                    "Alert" => "simple",
                                    "Titulo" => "ERROR",
                                    "Texto" => "No se ha registrado el la cuenta del Cliente",
                                    "Tipo" => "error"
                                ];
                            }
                        } else {
    ...
    public function paginadorUserController($pagina, $registros, $privilegio, $codigo, $busq)
    {
        ...
        if (isset($busq) && $busq != "") {
            ...
            WHERE ((cuentaCodigo!='$codigo')  AND (userApellido LIKE '%$busq%' 
