...
class modeloVideojuego extends modeloPrincipal
{
    ...
    {
        $sql = modeloPrincipal::conectDB()->prepare("INSERT INTO videojuego(vidCodigo,vidTitulo, vidPais,vidAnno,vidPrecio,vidPlataforma,vidAnalisis,vidImagen,vidGuiaPDF,generoCodigo,publisherCodigo,desarrCodigo)
        VALUES(:codigo,:titulo,:pais,:anno,:precio,:plataforma,:analisis,:imagen,:pdf,:genCodigo,:pubCodigo,:desarCodigo)");
