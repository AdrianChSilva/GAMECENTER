			...
			<?php if ($_SESSION['tipoGC'] == "Administrador") : ?>
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="<?php echo SERVERURL ?>desarrolladora/"><i class="zmdi zmdi-balance zmdi-hc-fw"></i> Desarrolladora</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL ?>genero/"><i class="zmdi zmdi-labels zmdi-hc-fw"></i> Géneros</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL ?>publisher/"><i class="zmdi zmdi-truck zmdi-hc-fw"></i> Publishers</a>
						</li>
						<li>
							<a href="<?php echo SERVERURL ?>videojuego/"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Nuevo Videojuego</a>
						</li>
					</ul>
				</li>
				<li>
