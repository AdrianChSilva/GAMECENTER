...
<div class="container-fluid">
    <h2 class="text-titles text-center">Género seleccionado</h2>
    <div class="row">
        <div class="col-xs-12">
            <div class="list-group">
                <div class="list-group-item">
                    ...
                    <div class="row-content">
                        <h4 class="list-group-item-heading">1 - Título completo del videojuego</h4>
                        <p class="list-group-item-text">
                            <strong>Autor: </strong>Nombre Autor del videojuego <br>
                            ...
                            <a href="book-config.html" class="btn btn-primary" title="Gestionar videojuego"><i class="zmdi zmdi-wrench"></i></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="list-group-item">
                    ...
                    <div class="row-content">
                        <h4 class="list-group-item-heading">2 - Título completo del videojuego</h4>
                        <p class="list-group-item-text">
                            <strong>Autor: </strong>Nombre Autor del videojuego <br>
                            <a href="book-info.html" class="btn btn-primary" title="Más información"><i class="zmdi zmdi-info"></i></a>
                            <a href="#!" class="btn btn-primary" title="Ver PDF"><i class="zmdi zmdi-file"></i></a>
