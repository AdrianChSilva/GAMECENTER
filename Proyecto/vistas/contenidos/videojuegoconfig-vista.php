...
<div class="container-fluid">
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="zmdi zmdi-refresh"></i> &nbsp; ACTUALIZAR VIDEOJUEGO</h3>
        </div>
                ...
                <fieldset>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                                    ...
                                    <input pattern="[a-zA-Z0-9-]{1,30}" class="form-control" type="hidden" name="codigo-up" value="<?php echo $camposForm['vidCodigo'] ?>"  required="" maxlength="30">

                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">Título *</label>
                                    <input pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="titulo-up" value="<?php echo $camposForm['vidTitulo'] ?>"  required="" maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">País</label>
                                    <input pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" type="text" name="pais-up" value="<?php echo $camposForm['vidPais'] ?>"  maxlength="30">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    ...
                                    <textarea name="analisis-up" class="form-control" rows="3"><?php echo $camposForm['vidAnalisis'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="file" name="imagen-up" value="<?php echo $camposForm['vidImagen'] ?>" accept=".jpg, .png, .jpeg">
                            <div class="input-group">
                                <input type="text" readonly=""  class="form-control" value="<?php echo $camposForm['vidImagen'] ?>" placeholder="Elija la imágen...">
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <input type="file" name="pdf-up" value="<?php echo $camposForm['vidGuiaPDF'] ?>" accept=".pdf">
                            <div class="input-group">
                                <input type="text" readonly="" class="form-control" value="<?php echo $camposForm['vidGuiaPDF'] ?>" placeholder="Elija el PDF...">
                                <span class="input-group-btn input-group-sm">
                                    <button type="button" class="btn btn-fab btn-fab-mini">
                                        <i class="zmdi zmdi-attachment-alt"></i>
                                    </button>
